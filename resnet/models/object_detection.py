...
sys.path.append("..")
import resnet.lib.label_map_util
...
class Net:
    ...
    def _load_labels(self):
        self.label_map = resnet.lib.label_map_util.load_labelmap(self.labels_fp)
        self.categories = resnet.lib.label_map_util.convert_label_map_to_categories(self.label_map, max_num_classes=self.num_classes, use_display_name=True)
        self.category_index = resnet.lib.label_map_util.create_category_index(self.categories)
    ...
    def _display(self, filtered_results, processed_img, display_img,filename):
    ...
    def predict(self, img, display_img,filename):
        ...
        with self.graph.as_default():
            ...
            self._display(filtered_results, processed_img=img_copy, display_img=display_img,filename=filename)
